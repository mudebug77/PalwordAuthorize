...
namespace ET
{
    public static class Game
    {
        ...
        public static T AddSingleton<T, A>(A a) where T : Singleton<T>, ISingletonAwake<A>, new()
        {
            T singleton = new();
            singleton.Awake(a);
        ...
        public static T AddSingleton<T, A, B>(A a, B b) where T : Singleton<T>, ISingletonAwake<A, B>, new()
        {
            T singleton = new();
            singleton.Awake(a, b);
        ...
        public static T AddSingleton<T, A, B, C>(A a, B b, C c) where T : Singleton<T>, ISingletonAwake<A, B, C>, new()
        {
            T singleton = new();
